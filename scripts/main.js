...
(function createDOM() {
    ...
    for (var property in jsonOrgan) {
        if (jsonOrgan.hasOwnProperty(property)) {
            ...
            if (!document.getElementById("ul-" + jsonOrgan[property].FKUnidade)) {
                ...
                /*** FKUnidade é a coluna filho que irá indicar a coluna PAI da tabela ***/
                ul.setAttribute("id", "ul-" + jsonOrgan[property].FKUnidade);
                ul.setAttribute("class", "hide");
                docfrag.appendChild(ul);
                /*** FKUnidade é a coluna filho que irá indicar a coluna PAI da tabela ***/
                document.getElementById("li-" + jsonOrgan[property].FKUnidade).appendChild(docfrag)
            }

            li = document.createElement("li");
            /*** idunidade é a coluna PAI da tabela ***/
            li.setAttribute("id", "li-" + jsonOrgan[property].idunidade);
            /*** FKUnidade é a coluna filho que irá indicar a coluna PAI da tabela ***/
            /*** .sigla = COLUNA SIGLA DA TABELA UNIDADE ***/
            /*** .nomeUnidade = COLUNA nomeUnidade DA TABELA UNIDADE ***/
            document.getElementById("ul-" + jsonOrgan[property].FKUnidade).appendChild(li).innerHTML = '<div class="wrap-infos wrap-infos-padrao">' + '<p class="nome">' + jsonOrgan[property].sigla + "</p>" + '<p class="cargo">' + jsonOrgan[property].nomeUnidade + "</p>" + "</div>"
        }
    }
})();
