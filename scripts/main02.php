<?php  
    ...
    $sql = "SELECT obunidadeagrv.nomeUnidade, obunidadeagrv.sigla, obvaloragrv.objetivo 
  FROM objetivo AS obvaloragrv
  INNER JOIN unidade AS obunidadeagrv
     ON ( obvaloragrv.FKUnidade = obunidadeagrv.idunidade )
  INNER JOIN objetivodireto_objetivoindireto as obagregavalor    
     ON ( obagregavalor.FKObjetivoDir = obvaloragrv.idobjetivo )";
